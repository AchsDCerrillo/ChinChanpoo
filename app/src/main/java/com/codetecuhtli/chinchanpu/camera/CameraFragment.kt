...
import com.codetecuhtli.chinchanpu.tflite.Classifier
import com.codetecuhtli.chinchanpu.utils.ImageUtils
                ...
                if (isProcessingFrame) {
                    ...
                    activity?.runOnUiThread {
                        if (!results.isNullOrEmpty()){
                            tvItem.text = results[0].title
                            tvConfidence.text = String.format(
                                    "%.2f",
                                    (results[0].confidence?.times(100))
                            ) + "%";
                        }
...
//                LOGGER.d("Initializing buffer %d at size %d", i, buffer.capacity())
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        classifier = Classifier(activity!!.assets, mModelPath, mLabelPath, mInputSize);
...
//            LOGGER.i("Opening camera preview: " + previewSize.width + "x" + previewSize.height)
    ...
    companion object {
        ...
        @JvmField val PIC_FILE_NAME = "pic_amlan.jpg"
